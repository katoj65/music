...
<ion-toolbar>
<ion-searchbar placeholder="Search for music, artists.."></ion-searchbar>
</ion-toolbar>
...
import { IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonButtons, IonButton, IonSearchbar  } from '@ionic/vue';
  import { menuOutline, searchOutline,ellipsisVertical, notifications, cloudDownload } from 'ionicons/icons';
